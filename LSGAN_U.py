...
class Network:
    ...
    def train(self,configure):
        ...
        # discriminator loss
        gan_d_loss = tf.reduce_mean(XY_fake_pair*XY_fake_pair/2) + tf.reduce_mean((XY_real_pair-1)*(XY_real_pair-1)/2)
        ...
        gan_g_loss = tf.reduce_mean((XY_fake_pair-1)*(XY_fake_pair-1)/2)
        gan_g_w = 5
        ae_w = 100 - gan_g_w
